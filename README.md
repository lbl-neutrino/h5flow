...
To install on CORI, follow this [https://docs.nersc.gov/development/languages/python/parallel-python/]
guide for how to install a parallel-compatible h5py build.
...
On CORI::
   ...
   salloc -N <nodes> --ntasks-per-node <cpus> -t <time limit> -C knl -q interactive
   module load python
   source activate h5flow # or whatever your environment is called
   srun h5flow <args>
